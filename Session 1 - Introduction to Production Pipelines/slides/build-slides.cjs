...
async function createPresentation() {
    ...
    pptx.title = 'Module 5 Session 1 - Introduction to Production Pipelines';
    ...
    const outputPath = path.join(slidesDir, '..', 'Session 1 - Introduction to Production Pipelines.pptx');
